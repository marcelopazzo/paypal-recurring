  ...
  module Recurring
    class Request
      ...
      ATTRIBUTES = {
        ...
        :discount_category     => "L_PAYMENTREQUEST_0_ITEMCATEGORY1",
        :discount_name         => "L_PAYMENTREQUEST_0_NAME1",
        :discount_amount       => "L_PAYMENTREQUEST_0_AMT1",
        :discount_quantity     => "L_PAYMENTREQUEST_0_QTY1",
        :credit_category       => "L_PAYMENTREQUEST_0_ITEMCATEGORY2",
        :credit_name           => "L_PAYMENTREQUEST_0_NAME2",
        :credit_amount         => "L_PAYMENTREQUEST_0_AMT2",
        :credit_quantity       => "L_PAYMENTREQUEST_0_QTY2",
        :email                 => "EMAIL",
